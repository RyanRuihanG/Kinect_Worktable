...
## KincectBodyBasics
Functions: The Kinect records the real-time hands position. The upper system then processes the position data and convert encode it to the lower system through the serial communication. Meanwhile, the upper system obtains the feedback data from the upper system continously. The decoder module works to read understandable information.  
